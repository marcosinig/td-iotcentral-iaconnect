...
IOT_CENTRAL_TEMPLATE=fdf72d44-d6f0-4ebe-9b30-6e02287bd3a4
...
services:
  mobius:
    image: mobiusflow/mobiusflow-tdc2r:1.7.0-rc.1-140
  ...
  tdc2rsetup:
    ...
    image: mobiusflow/td-c2r-quick-setup:1.0.0-rc.1-51
    privileged: false
    restart: always
    ports:
      - 8082:8080
